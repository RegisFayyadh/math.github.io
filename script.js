document.write("<h4>math.round == mengembalikan nilai dari pembulatan.bilangan(x) terdekat</h4>");
...
document.write("<h4>Math.floor == melakukan/mengembalikan nilai dari pembulatan.bilangan(x) ke bawah</h4>");
...
document.write("<h4>Math.ceil == melakukan/mengembalikan nilai dari pembulatan.bilangan(x) ke atas</h4>");
...
document.write("<h4>Math.pow == melakukan perpangkatan dimana x adalah basisnya dan y pangkatnya.</h4>");
...
document.write("<h4>Math.sqrt == mengembalikan nilai akar</h4>");
